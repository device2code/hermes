...
class SystemRequestPasswordResetForm extends TPage
{
    ...
    function __construct($param)
    {
        ...
        $btn_back = $this->form->addAction(_t('Back'), new TAction(array('LoginForm', 'onLoad')), '');
        $btn_back->class = 'btn btn-danger';
        $btn_back->style = 'height: 40px;width: 90%;display: block;margin: auto; margin-top:20px;font-size:17px;';
